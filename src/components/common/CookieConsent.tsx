        ...
        <div className="relative z-10">
          <div className="mb-3 flex items-center gap-3 md:mb-4">
            ...
            <button 
              ...
              className="ml-auto rounded-lg p-1.5 text-slate-500 dark:text-slate-400 transition-colors hover:bg-black/5 dark:bg-white/5 hover:text-slate-900 dark:text-white"
            >
              <X size={16} />
            </button>
          </div>

          <p className="mb-6 text-xs leading-relaxed text-slate-600 dark:text-slate-300/85">
            {isVi 
          ...
          <div className="flex flex-col gap-2">
            ...
            <button 
              ...
              className="flex w-full items-center justify-center gap-2 rounded-xl border border-black/10 dark:border-white/10 py-2.5 text-[10px] font-black uppercase tracking-[0.12em] text-slate-500 dark:text-slate-400 transition-all hover:bg-black/5 dark:bg-white/5 hover:text-slate-200"
            >
              <Info size={12} />
