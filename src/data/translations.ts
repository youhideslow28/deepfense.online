...
export const TRANSLATIONS: Record<Language, TranslationData> = {
  vi: {
    ...
    hero_desc: "Dự án huấn luyện cộng đồng về Deepfake bởi sinh viên VKU. Hãy trang bị kiến thức để bảo vệ bản thân và gia đình trước các cuộc tấn công AI tinh vi.",
    ...
    agent_welcome: "**Xin chào! Tôi là trợ lý ảo DEEPFENSE AGENT.**\n\n**Hiện máy quét AI đang khóa trong giai đoạn tìm dataset và train model. Tôi có thể hỗ trợ:**\n- **Phân tích tình huống:** Nhận diện dấu hiệu lừa đảo trong tin nhắn, cuộc gọi, nội dung đáng ngờ.\n- **Hướng dẫn xác minh:** Gợi ý cách kiểm tra nguồn, bằng chứng và kênh liên hệ an toàn.\n- **Ứng cứu khẩn cấp:** Hướng dẫn từng bước khi bị lộ lọt dữ liệu hoặc bị đe dọa.\n\n*Hãy mô tả tình huống hoặc dán đường link đáng ngờ để tôi hướng dẫn cách kiểm tra.*",
    agent_placeholder: "Mô tả tình huống hoặc dán link đáng ngờ...",
    result_pass: "AN TOÀN",
    ...
    tools_scan_desc: "Quét ngữ cảnh hành vi dùng được ngay bằng checklist xác minh. Các module upload media, chấm điểm AI và giám định tự động vẫn khóa trong giai đoạn tìm dataset, train model và benchmark.",
    tools_protect_desc: "Công nghệ Fawkes giúp thêm một lớp nhiễu rất nhẹ vào ảnh cá nhân, để AI khó học lại khuôn mặt của bạn. Deepfense đang giữ hướng này cho bản nâng cấp tiếp theo.",
  ...
  en: {
    ...
    hero_desc: "Community training project on Deepfakes by VKU students. Empower yourself with knowledge to protect your family against sophisticated AI attacks.",
    btn_scan: "RISK SCAN",
    ...
    agent_welcome: "**Hello! I am your DEEPFENSE AGENT.**\n\n**The AI scanner is currently locked while datasets are sourced and the model is trained. I can still help with:**\n- **Scenario analysis:** Identify scam signals in messages, calls, and suspicious content.\n- **Verification guidance:** Suggest source checks, evidence handling, and safer contact channels.\n- **Emergency response:** Provide step-by-step guidance after data exposure or threats.\n\n*Describe the situation or paste a suspicious link for verification guidance.*",
    agent_placeholder: "Describe a case or paste a suspicious link...",
    result_pass: "SECURE",
    result_fail: "DANGER",
    ...
    tools_scan_desc: "Behavioral context scanning is available now as a verification checklist. Media upload, AI scoring, and automated forensics remain locked while Deepfense sources datasets, trains models, and validates benchmarks.",
    tools_protect_desc: "Fawkes adds a very light hidden layer to personal photos, making it harder for AI to learn your face. Deepfense keeps this direction for the next upgrade.",
