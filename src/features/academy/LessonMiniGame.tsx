          ...
          <div className="space-y-2 mb-4">
            {data.targets.map((target, i) => (
              ...
              >
                ...
                <p className="text-slate-600 dark:text-slate-300 text-xs pl-6 leading-relaxed">{lang === 'vi' ? target.explanation.vi : target.explanation.en}</p>
              </div>
            ))}
          </div>
        </>
      ...
      <div className="flex gap-3">
        {!submitted ? (
          <button
            ...
            className="flex-1 py-2.5 rounded-lg bg-amber-500 hover:bg-amber-400 active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed text-slate-900 dark:text-white font-bold text-sm transition-all"
          >
            {t.minigame_check}
          </button>
        ) : (
          <>
            ...
            <button
              ...
              className="flex-1 py-2.5 rounded-lg bg-green-600 hover:bg-green-500 active:scale-95 text-slate-900 dark:text-white font-bold text-sm transition-all flex items-center justify-center gap-2"
            >
              ...
              className={`p-3 rounded-xl border text-xs font-semibold transition-all select-none ${
                isOver
                  ...
                  : isActive
                    ...
                    : 'border-zinc-700 bg-zinc-800/60 text-slate-600 dark:text-slate-300 cursor-default'
              }`}
            >
          ...
          {data.cards.filter(c => assignments[c.id]).map(card => {
            ...
            return (
              <div
                ...
                className="flex items-center gap-2 p-2.5 rounded-lg bg-zinc-800/50 border border-zinc-700/60 text-xs text-slate-600 dark:text-slate-300 cursor-pointer hover:border-red-700/60 hover:text-red-400 transition-all group"
              >
                ...
                >
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">{lang === 'vi' ? card.explanation.vi : card.explanation.en}</p>
                    </div>
                  </div>
                </div>
              );
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-slate-600 dark:text-slate-300 mt-0.5 leading-relaxed">{lang === 'vi' ? step.description.vi : step.description.en}</p>
                  </div>
                  {correct
              ...
              className={`flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold border transition-all ${
                isAvailable
                  ...
                  : isUsed && !submitted
                    ...
                    : 'border-zinc-700 bg-zinc-800/60 text-slate-600 dark:text-slate-300'
              }`}
            >
            ...
            return (
              <div
                ...
                className={`flex items-center gap-2 p-2.5 rounded-lg border text-xs cursor-pointer hover:border-red-700/60 transition-all group ${
                  isNew ? 'border-green-500/60 bg-green-900/20 scale-[1.02]' : 'bg-zinc-800/40 border-zinc-700/60 text-slate-600 dark:text-slate-300'
                }`}
              >
                ...
                >
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">{lang === 'vi' ? scenario.explanation.vi : scenario.explanation.en}</p>
                    </div>
                  </div>
                </div>
              );
...
const RiskMeter: React.FC<{ data: RiskMeterData; lang: Language; onDone: (score: number) => void }> = ({
  ...
  return (
    <div>
      ...
      {/* Scenario number */}
      <p className="text-[11px] text-slate-500 dark:text-slate-400 mb-2 font-bold uppercase tracking-[0.12em]">
      ...
      <div className="mb-5">
        ...
        <div className="flex items-center justify-between mb-2">
          <span className="text-xs text-slate-500 dark:text-slate-400">{riskLabel(1)}</span>
          ...
          <span className="text-xs text-slate-500 dark:text-slate-400">{riskLabel(5)}</span>
        </div>
        ...
        <div className="flex justify-between text-[10px] text-zinc-600 px-1">
          {[1, 2, 3, 4, 5].map(n => (
            <span key={n} className={n === currentRating ? 'font-bold text-slate-600 dark:text-slate-300' : ''}>{n}</span>
          ))}
        </div>
      </div>
      ...
      {revealed[currentIdx] && (
        <div className="bg-zinc-800/70 border border-zinc-600/60 rounded-xl p-4 mb-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1">
              <div className="text-xs text-slate-600 dark:text-slate-300 mb-0.5">{t.minigame_expert_says}</div>
          ...
          <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">{lang === 'vi' ? scenario.explanation.vi : scenario.explanation.en}</p>
        </div>
      )}
      ...
      <div className="flex gap-2">
        {!revealed[currentIdx] ? (
          <button
            ...
            className="flex-1 py-2.5 rounded-lg bg-amber-500 hover:bg-amber-400 active:scale-95 text-slate-900 dark:text-white font-bold text-sm transition-all"
          >
            {t.minigame_check}
          </button>
    ...
    >
      ...
      <div className="flex items-start gap-3 mb-5 pb-4 border-b border-amber-500/15">
        ...
        <div className="shrink-0 text-right">
          <div className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wide">{t.minigame_reward}</div>
