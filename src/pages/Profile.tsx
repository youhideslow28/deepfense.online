          ...
          <div className="lg:col-span-7">
            <div className="glass-dark rounded-2xl border border-white/10 p-5 md:p-8">
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <button onClick={handleResetPassword} disabled={busy || !hasPassword} className="inline-flex items-center justify-center gap-2 rounded-lg border border-amber-400/20 bg-amber-400/10 px-4 py-3 text-xs font-black uppercase tracking-[0.12em] text-amber-200 hover:bg-amber-400/15 disabled:opacity-40">
