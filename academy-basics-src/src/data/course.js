      ...
      },
      {
        ...
        checkpoint: checkpoint('4.3', [
          ...
          data: {
            ...
            cards: [
              { id: 'c1', text: 'Mí mắt không nháy trong suốt 30 giây', correctBucket: 'deepfake' },
              { id: 'c2', text: 'Răng dính liền thành một khối, mất viền răng cửa', correctBucket: 'deepfake' },
              { id: 'c3', text: 'Ánh sáng trên mặt khác với ánh sáng cảnh nền', correctBucket: 'deepfake' },
              { id: 'c4', text: 'Tai trái và tai phải có hình dạng khác nhau', correctBucket: 'deepfake' },
              { id: 'c5', text: 'Khuôn mặt có nốt ruồi, vết tàn nhang tự nhiên', correctBucket: 'normal' },
              { id: 'c6', text: 'Tóc bay theo gió, có vài sợi rối ngẫu nhiên', correctBucket: 'normal' },
              { id: 'c7', text: 'Bóng đổ trên mặt khớp với nguồn sáng phòng', correctBucket: 'normal' },
              { id: 'c8', text: 'Viền hàm dưới mờ, hoà lẫn vào cổ khi quay đầu', correctBucket: 'deepfake' },
            ],
          },
        }, 2),
      },
      ...
      },
      {
        ...
        checkpoint: checkpoint('5.1 Kiểm tra nhanh: tiền bạc và mạo danh', [
          ...
          data: {
            ...
            scenarios: [
              { id: 's1', text: 'Người tự xưng nhân viên ngân hàng gọi báo "phát hiện giao dịch lạ" và yêu cầu đọc OTP để khoá.', correctRule: 'hangup' },
              { id: 's2', text: 'Sếp nhắn Telegram giọng giống thật, yêu cầu chuyển 50 triệu gấp vào tài khoản lạ.', correctRule: 'verify' },
              { id: 's3', text: 'Bạn vừa lỡ đọc OTP rút tiền cho người gọi. Ngân hàng chưa khoá tài khoản.', correctRule: 'change_pw' },
              { id: 's4', text: 'Điện thoại đột nhiên mất sóng và bạn không nhận được SMS — nghi bị tráo SIM.', correctRule: 'goto_store' },
              { id: 's5', text: 'Một app "kiểm tra thuế" được gửi qua Zalo, sau khi cài thấy app yêu cầu quyền truy cập SMS và Accessibility.', correctRule: 'delete_app' },
            ],
          },
        }, 3),
      },
      ...
      },
      {
        ...
        checkpoint: checkpoint('6.1 Kiểm tra nhanh: Deepfense Shield', [
          ...
          data: {
            ...
            cards: [
              { id: 'u1', text: 'https://vietcombank.com.vn/login', correctBucket: 'real' },
              { id: 'u2', text: 'https://vietc0mbank-secure.com/login', correctBucket: 'fake' },
              { id: 'u3', text: 'https://momo.vn/khuyen-mai', correctBucket: 'real' },
              { id: 'u4', text: 'http://momo-uudai.tk/nhan-thuong', correctBucket: 'fake' },
              { id: 'u5', text: 'https://bit.ly/3xK9aZq (rút gọn — không rõ đích)', correctBucket: 'suspicious' },
              { id: 'u6', text: 'https://shopee.vn.security-update.net/account', correctBucket: 'fake' },
            ],
          },
        }, 3),
      },
