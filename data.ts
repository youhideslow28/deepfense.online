...
export const NEWS_DATA: Record<Language, NewsItem[]> = {
  vi: [
    { tag: "HÀ NỘI", title: "Giả mạo Công an lừa đảo chiếm đoạt tài sản", date: "11/2025", loss: "2.3 Tỷ VNĐ", desc: "Đối tượng dùng Deepfake mặc quân phục để gọi video lừa đảo người dân qua Zalo.", url: "https://vtv.vn/tim-kiem.htm?keywords=deepfake" },
    { tag: "TP.HCM", title: "Chiêu trò 'người thân cấp cứu' bằng Deepfake", date: "10/2025", loss: "500 Triệu VNĐ", desc: "Kẻ xấu giả giọng và mặt con cái đang cấp cứu để hối thúc cha mẹ chuyển tiền gấp.", url: "https://tuoitre.vn/tim-kiem.htm?keywords=deepfake" },
    { tag: "CẢNH BÁO", title: "Cuộc gọi video vay tiền bùng phát cuối năm", date: "12/2025", loss: "Hàng tỷ đồng", desc: "Tội phạm lợi dụng dịp lễ tết để giả mạo người thân vay tiền, mượn vốn khẩn cấp.", url: "https://dantri.com.vn/tim-kiem.htm?keywords=deepfake" },
    { tag: "TÍN DỤNG", title: "Giả mạo nhân viên ngân hàng qua Zalo", date: "01/2026", loss: "800 Triệu VNĐ", desc: "Dùng Deepfake mặc đồng phục ngân hàng yêu cầu khách hàng đọc mã OTP.", url: "https://vneconomy.vn/tim-kiem.htm?keywords=deepfake" },
    { tag: "GIÁO DỤC", title: "Lừa đảo học phí sinh viên bằng video ảo", date: "02/2026", loss: "300 Triệu VNĐ", desc: "Giả mạo giáo viên gọi điện trực tiếp yêu cầu phụ huynh đóng học phí khẩn cấp.", url: "https://giaoduc.net.vn/tim-kiem.htm?keywords=deepfake" },
    { tag: "CHỨNG KHOÁN", title: "Deepfake lùa gà đầu tư tài chính ảo", date: "03/2026", loss: "15 Tỷ VNĐ", desc: "Tạo video giả mạo các chuyên gia kinh tế nổi tiếng để kêu gọi chuyển tiền đầu tư.", url: "https://cafef.vn/tim-kiem.htm?keywords=deepfake" },
    { tag: "TÌNH CẢM", title: "Mất trắng sau cuộc gọi với 'người yêu Tây'", date: "02/2026", loss: "2 Tỷ VNĐ", desc: "Kẻ gian dùng AI tạo khuôn mặt nam giới ngoại quốc gọi điện hẹn hò qua Telegram.", url: "https://vietnamnet.vn/tim-kiem.htm?keywords=deepfake" },
    { tag: "DOANH NGHIỆP", title: "Kế toán chuyển nhầm 5 tỷ do sếp gọi video", date: "01/2026", loss: "5 Tỷ VNĐ", desc: "Cuộc họp nội bộ bị giả mạo hoàn toàn từ hình ảnh đến giọng nói của Giám đốc.", url: "https://vtv.vn/tim-kiem.htm?keywords=deepfake" },
    { tag: "NGÂN HÀNG", title: "Cảnh báo lừa đảo qua mặt eKYC khuôn mặt", date: "07/2025", loss: "Chưa thống kê", desc: "Tội phạm dùng Deepfake vượt qua hệ thống xác thực của một số tổ chức tài chính.", url: "https://vnexpress.net/tim-kiem.htm?keywords=deepfake" },
    { tag: "GIẢI TRÍ", title: "Làn sóng ghép mặt nghệ sĩ vào video nhạy cảm", date: "06/2025", loss: "Uy tín", desc: "Công nghệ Deepfake khiêu dâm tấn công các nghệ sĩ gây bức xúc dư luận.", url: "https://thanhnien.vn/tim-kiem.htm?keywords=deepfake" },
    { tag: "TOÀN CẦU", title: "Tập đoàn đa quốc gia mất trắng 25 triệu USD", date: "02/2024", loss: "25 Triệu USD", desc: "Nhân viên tài chính chuyển khoản sau cuộc họp video với 'Giám đốc' và 'đồng nghiệp' hoàn toàn do AI tạo ra.", url: "https://edition.cnn.com/2024/02/04/asia/deepfake-cfo-scam-hong-kong-intl-hnk/index.html" },
    { tag: "CHÍNH TRỊ", title: "Deepfake can thiệp bầu cử tổng thống Mỹ", date: "01/2024", loss: "An ninh quốc gia", desc: "Hàng ngàn cử tri nhận được cuộc gọi tự động giả giọng Tổng thống khuyên không đi bỏ phiếu.", url: "https://www.reuters.com/world/us/new-hampshire-investigates-fake-biden-robocall-meant-discourage-voters-2024-01-22/" },
    { tag: "TỶ PHÚ", title: "CEO Ferrari suýt sập bẫy lừa đảo qua WhatsApp", date: "07/2024", loss: "Trọng yếu", desc: "Kẻ gian dùng AI giả giọng CEO Ferrari nhắn tin và gọi điện yêu cầu thực hiện thương vụ thâu tóm bí mật.", url: "https://www.bloomberg.com/news/articles/2024-07-25/ferrari-s-ceo-was-targeted-by-a-deepfake-he-wasn-t-fooled" },
    { tag: "HÀN QUỐC", title: "Vấn nạn tống tiền bằng video khiêu dâm Deepfake", date: "08/2024", loss: "Danh dự", desc: "Hàng loạt sinh viên nữ tại đại học Hàn Quốc bị ghép mặt vào video nhạy cảm để tống tiền.", url: "https://koreajoongangdaily.hankooki.com/page/view/20240827170810" },
    { tag: "TÀI CHÍNH", title: "Livestream giả mạo CEO Binance lừa tiền ảo", date: "05/2024", loss: "Hàng triệu USD", desc: "Livestream dùng Deepfake người nổi tiếng quảng bá các dự án tiền mã hóa lừa đảo.", url: "https://cointelegraph.com/news/binance-co-founder-yi-he-deepfake-scams" },
    { tag: "SINGAPORE", title: "Giả mạo học sinh du học bị bắt cóc tống tiền", date: "11/2024", loss: "1.2 Triệu USD", desc: "Phụ huynh nhận được video call con mình đang bị trói và khóc lóc kêu cứu, thực chất do AI tạo ra.", url: "https://www.straitstimes.com/singapore/courts-crime/parents-of-overseas-students-fall-prey-to-scams-involving-fake-kidnappings-deepfakes" },
    ...
    { tag: "CÔNG NGHỆ", title: "Mã nguồn AI tạo video giả chỉ với 3 giây âm thanh", date: "08/2025", loss: "N/A", desc: "Công cụ mới cho phép tạo video giả mạo mượt mà chỉ với 1 bức ảnh và 3 giây âm thanh.", url: "https://tinhte.vn/search?q=deepfake" }
  ],
  en: [
    { tag: "HANOI", title: "Fake Police impersonation to steal property", date: "11/2025", loss: "$100k", desc: "Subjects used Deepfake uniforms to make scam video calls to citizens via Zalo.", url: "https://vtv.vn/tim-kiem.htm?keywords=deepfake" },
    { tag: "HCMC", title: "'Relative in ER' scam using Deepfake", date: "10/2025", loss: "$20k", desc: "Scammers spoofed a child's voice and face in an emergency to rush parents into wiring money.", url: "https://tuoitre.vn/tim-kiem.htm?keywords=deepfake" },
    { tag: "WARNING", title: "End-of-year video call loan scams surge", date: "12/2025", loss: "Millions", desc: "Criminals exploit the holiday season to impersonate relatives and ask for urgent loans.", url: "https://dantri.com.vn/tim-kiem.htm?keywords=deepfake" },
    { tag: "CREDIT", title: "Fake bank staff requesting OTP via Zalo", date: "01/2026", loss: "$35k", desc: "Scammers wore Deepfaked bank uniforms to trick victims into sharing their OTP codes.", url: "https://vneconomy.vn/tim-kiem.htm?keywords=deepfake" },
    { tag: "EDUCATION", title: "Student tuition fraud via virtual video calls", date: "02/2026", loss: "$12k", desc: "Fake teachers called parents directly via video to demand urgent tuition payments.", url: "https://giaoduc.net.vn/tim-kiem.htm?keywords=deepfake" },
    { tag: "STOCK", title: "Deepfake scams luring financial investors", date: "03/2026", loss: "$600k", desc: "AI-generated videos of famous economic experts urged people to invest in fake platforms.", url: "https://cafef.vn/tim-kiem.htm?keywords=deepfake" },
    { tag: "ROMANCE", title: "Lost everything to a fake 'Foreign Lover' call", date: "02/2026", loss: "$80k", desc: "Scammers used AI to generate attractive foreign faces for romance scams on Telegram.", url: "https://vietnamnet.vn/tim-kiem.htm?keywords=deepfake" },
    { tag: "CORP", title: "Accountant wires $200k after fake boss video call", date: "01/2026", loss: "$200k", desc: "An internal corporate meeting was entirely faked, including the image and voice of the Director.", url: "https://vtv.vn/tim-kiem.htm?keywords=deepfake" },
    { tag: "BANKING", title: "Warning on Deepfakes bypassing eKYC systems", date: "07/2025", loss: "TBD", desc: "Criminals successfully used Deepfakes to bypass facial authentication systems of several banks.", url: "https://vnexpress.net/tim-kiem.htm?keywords=deepfake" },
    { tag: "ENT", title: "Wave of celebrities mapped into explicit videos", date: "06/2025", loss: "Reputation", desc: "Pornographic Deepfake wave attacking artists caused public outrage and legal action.", url: "https://thanhnien.vn/tim-kiem.htm?keywords=deepfake" },
    { tag: "GLOBAL", title: "Multinational firm loses $25M in deepfake heist", date: "02/2024", loss: "$25 Million", desc: "Finance worker tricked into transferring funds after a video call with an AI-generated 'CFO'.", url: "https://edition.cnn.com/2024/02/04/asia/deepfake-cfo-scam-hong-kong-intl-hnk/index.html" },
    { tag: "POLITICS", title: "Deepfake audio of President interferes with election", date: "01/2024", loss: "National Security", desc: "Thousands of voters received robocalls faking the US President's voice advising against voting.", url: "https://www.reuters.com/world/us/new-hampshire-investigates-fake-biden-robocall-meant-discourage-voters-2024-01-22/" },
    { tag: "BILLIONAIRE", title: "Ferrari CEO nearly falls for WhatsApp deepfake", date: "07/2024", loss: "Critical", desc: "Scammers used AI to fake the Ferrari CEO's voice requesting a secret business transfer.", url: "https://www.bloomberg.com/news/articles/2024-07-25/ferrari-s-ceo-was-targeted-by-a-deepfake-he-wasn-t-fooled" },
    { tag: "KOREA", title: "Sextortion epidemic using Deepfake porn videos", date: "08/2024", loss: "Reputation", desc: "Korean university students shocked as their faces were mapped onto explicit videos for extortion.", url: "https://koreajoongangdaily.hankooki.com/page/view/20240827170810" },
    { tag: "CRYPTO", title: "Fake Binance CEO livestream scams crypto investors", date: "05/2024", loss: "Millions of USD", desc: "Livestreams used Deepfakes of the Binance CEO to promote fraudulent cryptocurrency projects.", url: "https://cointelegraph.com/news/binance-co-founder-yi-he-deepfake-scams" },
    { tag: "SINGAPORE", title: "Fake kidnapping of international student for ransom", date: "11/2024", loss: "$1.2 Million", desc: "Parents received a video call of their child crying and tied up, which was entirely AI-generated.", url: "https://www.straitstimes.com/singapore/courts-crime/parents-of-overseas-students-fall-prey-to-scams-involving-fake-kidnappings-deepfakes" },
    ...
    { tag: "TECH", title: "AI generates fake video with only 3 seconds of audio", date: "08/2025", loss: "N/A", desc: "A new tool allows generating seamless fake videos using just 1 photo and 3 seconds of audio.", url: "https://tinhte.vn/search?q=deepfake" }
  ]
};
