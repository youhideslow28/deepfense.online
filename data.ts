...
export const TRANSLATIONS: Record<Language, TranslationData> = {
  vi: {
    ...
    agent_welcome: "Xin chào! Tôi là DEEPFENSE AGENT. Hãy dán một đường link (URL) đáng ngờ vào đây để tôi quét qua VirusTotal nhé!",
  ...
  en: {
    ...
    agent_welcome: "Hello! I am DEEPFENSE AGENT. Paste any suspicious link (URL) here and I will scan it with VirusTotal for you!",
